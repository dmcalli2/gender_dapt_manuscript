...
## Relative treatment effect estimates (hazard ratios or risk ratios as available) for main treatment effects, stratified by diagnosis, as reported in original trial publications
...
```{r arr_plots_draw, fig.width=11, fig.height=16}
